  ...
  var body: some View {
    VStack {
      ...
      if showNotifications {
        ...
        .onAppear {
          if UserDefaults(suiteName: "group.wtf.savva.dime")!.object(
            forKey: "notificationOption") != nil
          {
            option = UserDefaults(suiteName: "group.wtf.savva.dime")!.integer(
              forKey: "notificationOption")
          }

          if UserDefaults(suiteName: "group.wtf.savva.dime")!.object(forKey: "customHour")
            != nil
            && UserDefaults(suiteName: "group.wtf.savva.dime")!.object(forKey: "customMinute")
              != nil
          {
            var components = DateComponents()
            components.hour = UserDefaults(suiteName: "group.wtf.savva.dime")!.integer(
              forKey: "customHour")
            components.minute = UserDefaults(suiteName: "group.wtf.savva.dime")!.integer(
              forKey: "customMinute")
...
func newNotification() {
  ...
  if UserDefaults(suiteName: "group.wtf.savva.dime")!.object(forKey: "notificationOption")
    != nil
  {
    option = UserDefaults(suiteName: "group.wtf.savva.dime")!.integer(
      forKey: "notificationOption")
  ...
  if option == 1 {
    ...
    if UserDefaults(suiteName: "group.wtf.savva.dime")!.object(forKey: "customHour") != nil,
      UserDefaults(suiteName: "group.wtf.savva.dime")!.object(forKey: "customMinute") != nil
    {
      components.hour = UserDefaults(suiteName: "group.wtf.savva.dime")!.integer(
        forKey: "customHour")
      components.minute = UserDefaults(suiteName: "group.wtf.savva.dime")!.integer(
